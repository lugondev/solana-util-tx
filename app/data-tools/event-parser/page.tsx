		...
		<div className='min-h-screen bg-gray-900 py-8'>
			<div className='max-w-6xl mx-auto px-4'>
				<div className='text-center mb-8'>
					<h1 className='text-4xl font-bold text-white mb-4'>📊 Event Log Parser</h1>
					<p className='text-xl text-gray-300 max-w-3xl mx-auto'>Parse and analyze event logs from Solana transactions. Extract program invocations, custom events, compute usage with advanced filtering and statistics.</p>
				</div>
				...
				<div className='max-w-6xl mx-auto mt-12'>
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
						<div className='bg-gray-800 p-6 rounded-lg border border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-3'>🔍 Transaction Analysis</h3>
							<p className='text-gray-300 text-sm'>Parse single/multiple transactions to extract events, program invocations, and detailed execution flow.</p>
						</div>

						<div className='bg-gray-800 p-6 rounded-lg border border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-3'>📝 Custom Event Detection</h3>
							<p className='text-gray-300 text-sm'>Auto-detect Jupiter swaps, Orca trades, Raydium AMM, token transfers with specialized parsing logic.</p>
						</div>

						<div className='bg-gray-800 p-6 rounded-lg border border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-3'>⚡ Performance Metrics</h3>
							<p className='text-gray-300 text-sm'>Track compute unit usage, program execution costs, and performance bottlenecks across transactions.</p>
						</div>

						<div className='bg-gray-800 p-6 rounded-lg border border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-3'>🎯 Advanced Filtering</h3>
							<p className='text-gray-300 text-sm'>Filter by programs, event types, include/exclude system programs, token programs with granular control.</p>
						</div>

						<div className='bg-gray-800 p-6 rounded-lg border border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-3'>📊 Real-time Statistics</h3>
							<p className='text-gray-300 text-sm'>View program usage statistics, event type distribution, success/failure rates with visual breakdowns.</p>
						</div>

						<div className='bg-gray-800 p-6 rounded-lg border border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-3'>💾 Export & Analysis</h3>
							<p className='text-gray-300 text-sm'>Export parsed events to JSON, copy individual event data, and integrate with external analysis tools.</p>
						</div>
					</div>
				</div>
				...
				<div className='max-w-6xl mx-auto mt-12 bg-gray-800 p-6 rounded-lg border border-gray-700'>
					<h3 className='text-lg font-semibold text-white mb-4'>🚀 Supported Programs & Events</h3>
				...
				{/* Event Types */}
				<div className='max-w-6xl mx-auto mt-12 bg-gray-800 p-6 rounded-lg border border-gray-700'>
					<h3 className='text-lg font-semibold text-white mb-4'>📋 Event Types Detected</h3>
