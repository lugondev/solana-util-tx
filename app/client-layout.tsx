					...
					<div className='flex-1 flex flex-col overflow-hidden'>
						...
						<header className='h-20 bg-gray-800 border-b-2 border-green-400/20 flex items-center justify-between px-4 lg:px-8'>
							<div className='flex items-center gap-4 lg:gap-6'>
								...
								<button className='lg:hidden p-2 text-green-400 hover:text-green-300 transition-colors' onClick={() => setIsMobileMenuOpen(true)}>
						...
						{/* Main Content Area */}
						<main className='flex-1 overflow-auto bg-gray-900 p-4 lg:p-8'>{children}</main>
