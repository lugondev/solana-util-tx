...
export function SearchProvider({children}: {children: React.ReactNode}) {
	const searchItems: SearchableItem[] = [
		...
		},
		{
			...
			description: 'Generate custom Solana addresses with specific prefixes',
		...
		},
		{
			...
			description: 'Generate multiple wallets with various export formats',
		...
		},
		{
			...
			description: 'Find Program Derived Addresses with constraints',
		...
		// Data Tools
		{
			...
			description: 'Decode/encode Borsh data with custom schemas',
		...
		},
		{
			...
			description: 'Parse and analyze transaction logs and events',
		...
		// Advanced Tools
		{
			...
			description: 'Manage program versions and upgrade history',
		...
		},
		{
			...
			description: 'Send tokens with advanced features',
		...
		// Transaction Tools
		{
			...
			description: 'Execute transactions with monitoring',
		...
		},
		{
			...
			description: 'Advanced simulation with detailed analysis',
		...
		// Account Management
		{
			...
			description: 'Explore account details and history',
